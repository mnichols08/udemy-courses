...
## Objective:
- [x] Build an app that is functionally similar to this: https://javascript-calculator.freecodecamp.rocks/.
...
### [Solution Link](https://mnichols08-calculator.netlify.app/)